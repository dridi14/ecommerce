...
- Ansible roles: common, php (8.2), nginx, magento (2.4.7-p1 via mirror.mage-os.org).
...
export TF_VAR_magento_admin_password="ChangeMe123!"
...
- Magento install uses mirror.mage-os.org to avoid auth keys; replace with official repo and Composer credentials if required.
